...
import com.hbase.dao.async.DisabledHBaseAsyncOperation;
import com.hbase.dao.async.HBaseAsyncOperation;
import com.hbase.dao.exception.HBaseAccessException;
import com.hbase.dao.exception.HBaseSystemException;
import com.hbase.dao.exception.ScanTaskException;
import com.hbase.dao.extractor.LimitRowMapperResultsExtractor;
import com.hbase.dao.extractor.ResultsExtractor;
import com.hbase.dao.extractor.RowMapperResultsExtractor;
import com.hbase.dao.handler.LimitEventHandler;
import com.hbase.dao.mapper.RowMapper;
import com.hbase.dao.mapper.ValueMapper;
import com.hbase.dao.parallel.DefaultThreadFactory;
import com.hbase.dao.parallel.ExecutorFactory;
import com.hbase.dao.parallel.ParallelResultScanner;
...
public class HBaseTemplate extends HBaseAccessor implements HBaseOperations {
    ...
    public void init() {
        ...
        if(getTableFactory() == null) {
            throw new IllegalArgumentException("tableFactory is required");
        }

        DefaultThreadFactory parallelScannerThreadFactory = new DefaultThreadFactory("hbase-dao-parallel-scanner");
    ...
    public <T> T execute(TableName tableName, TableCallback<T> action) {
        ...
        if(action == null) {
            throw new NullPointerException("Callback object must not be null");
        }
